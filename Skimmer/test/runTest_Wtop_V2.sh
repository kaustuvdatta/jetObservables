...
#python jetObservables_nSubProducer_WtopSel_V2.py --iFile TTToSemiLeptonic_UL18_testPFNano.root --local --selection '_WtopSel' --year '2018' --numEvents 10000 --isSigMC
time python jetObservables_nSubProducer_WtopSel_V2.py --iFile  'root://cms-xrd-global.cern.ch///store/user/kadatta/PFNano/106x_v02/SingleMuon/Run2017C-UL2017_MiniAODv2-v1_PFNanov2pt3/221116_104120/0000/nano_data2017_1.root' --local --selection '_WtopSel' --year '2017' --numEvents 20000 --isSigMC --runEra 'C'
