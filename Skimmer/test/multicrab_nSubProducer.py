...
if __name__ == '__main__':
    ...
    #dictSamples['UL17_ST_s-channel'] = ['',1]
    #dictSamples['UL17_ST_t-channel_top'] = ['',1]
    #dictSamples['UL17_ST_t-channel_antitop'] = ['',1]
    #dictSamples['UL17_ST_tW_top'] = ['',1]
    #dictSamples['UL17_ST_tW_antitop'] = ['',1]
