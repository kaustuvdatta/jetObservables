...
dictSamples = {
    ...
    'JetHT' : {
        '2017' :  {
            ...
            'skimmerHisto' : 'Rootfiles/jetObservables_histograms_JetHT2017ALL.root',
            'lumi' : 41473.09,
            'triggerList' : {
    ...
    'QCD_Pt-15to7000_TuneCH3_Flat_13TeV_herwig7' : {
        ...
        '2017' :  {
            ...
            'skimmerHisto' : 'Rootfiles/jetObservables_histograms_QCDHerwig2017.root',
            'nevents' : 19880000.,
            'nGenWeights' : 400452.339,
            },
        '2018' :  {
            'miniAOD' : [ '' ],
            'nanoAOD' : [ '' ],
