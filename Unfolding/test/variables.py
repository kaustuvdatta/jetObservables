...
for ijet in [ ('Jet1', 'Outer' ), ('Jet2', 'Central') ]:
    ...
    nSubVariables[ ijet[0]+'_tau_0p5_3' ] = {
		'bins' :  np.concatenate( ( np.array([ 0, 0.1 ]), np.arange( 0.14, 0.44, 0.04 ), np.array([ .6 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{3}^{0.5}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_0p5_4' ] = {
		'bins' :  np.concatenate( ( np.array([ 0, 0.08 ]), np.arange( 0.12, 0.42, 0.04 ), np.array([ .6 ]) ) ),
    ...
    nSubVariables[ ijet[0]+'_tau_1_1' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.54, 0.06 ), np.array([ .7 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{1}^{1}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_1_2' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.2, 0.02 ), np.array([ .2, .5 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{2}^{1}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_1_3' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.2, 0.02 ), np.array([ .36 ]) ) ),
    ...
    nSubVariables[ ijet[0]+'_tau_2_1' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.12, 0.02 ), np.arange(.16, .28, .06), np.array([ .5 ]) ) ),
    ...
    nSubVariables[ ijet[0]+'_tau_2_3' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.06, 0.01 ), np.array([ .2 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{3}^{2}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_2_4' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.05, 0.01 ), np.array([ .15 ]) ) ),
