...
for ijet in [ ('Jet1', 'Outer' ), ('Jet2', 'Central') ]:
    ...
    nSubVariables[ ijet[0]+'_tau_0p5_2' ] = {
		'bins' :  np.concatenate( ( np.array([ 0, 0.1 ]), np.arange( 0.16, 0.56, 0.06 ), np.array([ .8 ]) ) ),
    ...
    nSubVariables[ ijet[0]+'_tau_0p5_3' ] = {
		...
		'bins' :  np.concatenate( ( np.array([ 0, 0.1 ]), np.arange( 0.13, 0.46, 0.03 ), np.array([ .6 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{3}^{0.5}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_0p5_4' ] = {
		'bins' :  np.concatenate( ( np.array([ 0, 0.05 ]), np.arange( 0.08, 0.41, 0.03 ), np.array([ .6 ]) ) ),
    ...
    nSubVariables[ ijet[0]+'_tau_1_1' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.6, 0.06 ), np.array([  1.]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{1}^{1}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_1_2' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.3, 0.03 ), np.array([ .6 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{2}^{1}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_1_3' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.2, 0.02 ), np.array([ .4 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{3}^{1}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_1_4' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.16, 0.02 ), np.array([ .4 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{4}^{1}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_2_1' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.3, 0.03 ), np.array([ 1.]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{1}^{2}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_2_2' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.1, 0.02 ), np.array([ .4 ]) ) ),
		'label' : ijet[1]+' AK8 jet #tau_{2}^{2}',
		'alignLeg' : 'right'
		}
    nSubVariables[ ijet[0]+'_tau_2_3' ] = {
		'bins' :  np.concatenate( ( np.arange( 0., 0.05, 0.01 ), np.array([ .4 ]) ) ),
